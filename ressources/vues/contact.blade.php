...
<picture id="bgContact1">
    <source srcset="./liaisons/img/Bg_Contact_1_992.webp" media="(min-width: 992px)" />
    <source srcset="./liaisons/img/Bg_Contact_1_768.webp" media="(min-width: 768px)" />
    <img class="bgImg" src="./liaisons/img/Bg_Contact_1_320.webp" alt="image décorative 1" />
</picture>

<picture id="drawContact1">
    <source srcset="./liaisons/img/Dessin_Contact_1_992.webp" media="(min-width: 992px)" />
    <source srcset="./liaisons/img/Dessin_Contact_1_768.webp" media="(min-width: 768px)" />
    <img src="./liaisons/img/Dessin_Contact_1_320.webp" alt="dessin décoratif 1"/>
</picture>
    ...
    <form id="contactForm" action="index.php?controleur=message&action=inserer" id="contactForm" method="post">
        <div class="formRow">
            ...
            <div class="contactInput">
                ...
                <input type="text" id="fullname" name="prenom_nom" pattern="^[a-zA-ZÀ-ÿ'\s-]+$" @if (isset($_SESSION['validation'])) value='{{ $_SESSION['validation']['prenom_nom']['value'] }}' @endif required>
            ...
            <div class="contactInput">
                ...
                <input type="email" id="courriel" name="courriel" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" @if (isset($_SESSION['validation'])) value='{{ $_SESSION['validation']['courriel']['value'] }}' @endif required>
        ...
        <div class="contactInput">
            ...
            <input type="text" id="sujet" name="sujet" pattern="^[a-zA-ZÀ-ÿ'\s-]+$" @if (isset($_SESSION['validation'])) value='{{ $_SESSION['validation']['sujet']['value'] }}' @endif required>
...
<div id="contactPhoneWrapper" class="whiteGlass">
    ...
    <picture id="drawContact2">
        <source srcset="./liaisons/img/Dessin_Contact_2_992.webp" media="(min-width: 992px)" />
        <source srcset="./liaisons/img/Dessin_Contact_2_768.webp" media="(min-width: 768px)" />
        <img class="bgImg" src="./liaisons/img/Dessin_Contact_2_320.webp" alt="dessin décoratif 2"/>
    </picture>
