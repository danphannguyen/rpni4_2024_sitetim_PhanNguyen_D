...
<picture id="bgStage2">
    <source srcset="./liaisons/img/Bg_Stage_2_992.webp" media="(min-width: 992px)" />
    <source srcset="./liaisons/img/Bg_Stage_2_768.webp" media="(min-width: 768px)" />
    <img class="bgImg" src="./liaisons/img/Bg_Stage_2_320.webp" alt="image décorative 1" />
</picture>

<section id="stageHeaderWrapper" class="whiteGlass">
    <picture id="drawStage1">
        <source srcset="./liaisons/img/Dessin_Stage_1_992.webp" media="(min-width: 992px)" />
        <source srcset="./liaisons/img/Dessin_Stage_1_768.webp" media="(min-width: 768px)" />
        <img src="./liaisons/img/Dessin_Stage_1_320.webp" alt="dessin décoratif" />
    </picture>
    ...
    <picture id="drawStage3">
        <source srcset="./liaisons/img/Dessin_Stage_3_992.webp" media="(min-width: 992px)" />
        <source srcset="./liaisons/img/Dessin_Stage_3_768.webp" media="(min-width: 768px)" />
        <img src="./liaisons/img/Dessin_Stage_3_320.webp" alt="dessin décoratif" />
    </picture>
</section>

<section id="stageContentWrapper" class="whiteGlass">
    <picture id="drawStage2">
        <source srcset="./liaisons/img/Dessin_Stage_2_992.webp" media="(min-width: 992px)" />
        <source srcset="./liaisons/img/Dessin_Stage_2_768.webp" media="(min-width: 768px)" />
        <img src="./liaisons/img/Dessin_Stage_2_320.webp" alt="dessin décoratif" />
    </picture>
...
<section id="stageFooterWrapper" class="whiteGlass">
    <picture id="drawStage4">
        <source srcset="./liaisons/img/Dessin_Stage_4_992.webp" media="(min-width: 992px)" />
        <source srcset="./liaisons/img/Dessin_Stage_4_768.webp" media="(min-width: 768px)" />
        <img src="./liaisons/img/Dessin_Stage_4_320.webp" alt="dessin décoratif" />
    </picture>
