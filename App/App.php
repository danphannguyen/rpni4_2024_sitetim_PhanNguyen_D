    ...
    public static function getPDO(): PDO
    {
        ...
        if (!isset(App::$refPdo)) {
            if ($_SERVER['SERVER_NAME'] == 'localhost') {
                ...
                // À modifier...
                $serveur = 'localhost';
                $utilisateur = '24_rpni4_24'; // À modifier...
                $motDePasse = 'dhgkQP45f$54'; // À modifier...
                $nomBd = '24_rpni4_24'; // À modifier...
            }
        ...
        if ($urlControleur === 'site') {
            ...
            switch ($urlAction) {
                case 'index':
                    ...
                    break;
                case 'filtrer':
                    $objControleur->filtrer();
                    break;
                case 'fiche':
                    $objControleur->projetFiche($projetId);
                    break;
                default:
                    echo 'Erreur 404 - Action invalide';
            }
